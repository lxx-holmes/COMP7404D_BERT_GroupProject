...
def main():
    ...
    if args.model_type == 'roberta':
        ...
        model.roberta.embeddings.token_type_embeddings = torch.nn.Embedding(2, model.roberta.config.hidden_size)

        # Initialize it
        model.roberta.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0,
                                                                          std=model.roberta.config.initializer_range)
